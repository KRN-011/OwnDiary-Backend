...
import { createTradeController, getAllTradesController, updateTradeController, deleteTradeController, getTradeSymbolsController } from "./trade.controller.js";
...
router.get('/get-symbols', authMiddleware, getTradeSymbolsController)
